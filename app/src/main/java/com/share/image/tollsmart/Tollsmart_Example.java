 ...
 * @author leonid
 */
public class Tollsmart_Example {
    private static String URL = "http://tollsmartsandbox-env.elasticbeanstalk.com/TollsAPI/tolls";
...
//Case 1: set origin/destination and any via-points and the API will return Google routes with tolls:
        tollRequest.setOrigin("38.242529,-77.474573");
        tollRequest.setDestination("38.833269,-77.177113");
